...
/// Model picker that works with ProviderSelection (fixed providers or custom endpoints)
struct ProviderAwareModelPickerView: View {
    ...
    init(selection: ProviderSelection, currentModel: String, customEndpointsStore: CustomEndpointsStore, onSelect: @escaping (String) -> Void) {
        ...
        _modelService = StateObject(wrappedValue: LLMModelService(apiKeyStore: store, customEndpointsStore: customEndpointsStore))
    }
    ...
    private func loadModels() async {
        ...
        do {
            models = try await modelService.fetchModels(for: selection)
        } catch {
