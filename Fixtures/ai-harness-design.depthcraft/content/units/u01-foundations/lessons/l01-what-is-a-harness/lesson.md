...
:::demo id="sandbox-test":::

:::demo id="soft-fail-test":::
...
Learners need **stable structure** (units, lessons, quizzes) more than clever prose. The harness’s first product is a valid curriculum map and lesson bodies that match it — not a chatbot transcript.
